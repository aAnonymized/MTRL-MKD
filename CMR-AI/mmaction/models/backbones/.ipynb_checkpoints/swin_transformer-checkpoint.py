...
class WindowAttention3D(nn.Module):
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=False, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        coords = torch.stack(torch.meshgrid(
            coords_d, coords_h, coords_w, indexing="ij"))  # 3, Wd, Wh, Ww
...
class SwinTransformerBlock3D(nn.Module):
    ...
    def forward(self, x, mask_matrix):
        ...
        # print(f"shortcut {shortcut.shape} x {shortcut.shape}")
...
class SwinTransformer3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.window_size = window_size
        self.patch_size = patch_size
        self.head = I3DHead(num_classes=class_num)
        ...
        self.aug_patch_embed = PatchEmbed3D(
            patch_size=patch_size, in_chans=in_chans, embed_dim=embed_dim,
            norm_layer=norm_layer if self.patch_norm else None)
        ...
        self.fc_cls = nn.Linear(embed_dim, 1024)
